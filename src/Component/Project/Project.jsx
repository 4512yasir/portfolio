...
function Project() {
  ...
  return (
   ...
   <a href="https://calator.netlify.app/" target='_blank'><button>GO LIVE</button></a>     
        </div>
      </div>
 </div>
 <div className="projects"  style={{Display:'flex'}}>
      ...
      <div className="project-text">
        ...
        <p className='description'>This is a animated  landing page which took 1 day to build</p>
           <div className="buttons">
   <a href="https://ysc1.netlify.app/" target='_blank'><button>GO LIVE</button></a>     
        </div>
      </div>
 ...
 <div className="projects">
      ...
      <div className="project-text">
        ...
        <div className="buttons">
   <a href="https://tip-calculator-2-3.netlify.app/" target='_blank'><button>GO LIVE</button></a>     
        </div>
      </div>
 </div>
